...
import useMyStoreApi from "./useMyStoreApi";
      ...
      <div className="h-fit w-full flex">
        ...
        >
          ...
          <div className="flex gap-8">
            ...
            <textarea
              className="bg-transparent p-4 flex-1 outline-none placeholder:text-gray-600"
          ...
          <div className="flex gap-8">
            <h5 className="h-full w-48 hidden md:block p-4 px-8">
              {STORE_ADDRESS}
            </h5>
            <input
              className="bg-transparent p-4 flex-1 outline-none placeholder:text-gray-600"
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1">
              ...
              {thumbnailBase64 && (
                <div className="w-24 md:w-56 m-4 aspect-square relative rounded-md">
                  <BaseImage
                    src={thumbnailBase64}
                    alt=""
                    layout="fill"
